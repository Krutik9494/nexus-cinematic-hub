      ...
      <div className="aspect-[2/3] overflow-hidden relative">
        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1.5">
          <button
            ...
            aria-label="Favorite"
            className={`size-7 rounded-full glass flex items-center justify-center transition ${fav ? "text-[#ff3d77]" : "text-muted-foreground hover:text-[#ff3d77]"}`}
            style={fav ? { boxShadow: "0 0 14px rgba(255,61,119,0.6)" } : undefined}
          >
